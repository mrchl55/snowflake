(function($){$(document).ready(function(){AOS.init();$('nav .menu-menu-1-container').addClass('collapse navbar-collapse');$('nav .menu-menu-1-container').attr('id','navbarNav');$('nav #menu-menu-1').addClass('navbar-nav');$('.owl-carousel').owlCarousel({loop:!0,margin:10,nav:!0,responsive:{0:{items:1},768:{items:1},1000:{items:3}}})})})(jQuery);(function($){$(document).ready(function(){$('.item-apartments').click(function(){$('.apartments-desc h6').html($(this).find("a").html());$('.apartments-desc img').attr('src',$(this).find("img").attr('src'));$('.apartments-desc p').html('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.')});$('.item-blueprints').click(function(){$('.apartments-desc h6').html($(this).find("a").html());$('.apartments-desc img').attr('src',$(this).find("img").attr('src'));$('.apartments-desc p').html(' Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.')});$('.item-floor').click(function(){$('.apartments-desc h6').html($(this).find("a").html());$('.apartments-desc img').attr('src',$(this).find("img").attr('src'));$('.apartments-desc p').html('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.')})})})(jQuery);(function($){$(document).ready(function(){$('.snowflake-icon img').click(function(){$(this).rotate({count:4,duration:0.6,easing:'ease-out'})})});$.fn.rotate=function(options){var $this=$(this),prefixes,opts,wait4css=0;prefixes=['-Webkit-','-Moz-','-O-','-ms-',''];opts=$.extend({startDeg:!1,endDeg:360,duration:1,count:1,easing:'linear',animate:{},forceJS:!1},options);function supports(prop){var can=!1,style=document.createElement('div').style;$.each(prefixes,function(i,prefix){if(style[prefix.replace(/\-/g,'')+prop]===''){can=!0}});return can}
